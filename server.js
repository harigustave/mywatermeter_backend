...
const hfUrl = "https://router.huggingface.co/hf-inference/v1/models/harigustave/watermeterapp";
...
app.post("/predict", upload.single("image"), async (req, res) => {
  try {
    ...
    console.log("📤 Sending image to Hugging Face:", hfUrl);
    ...
    try {
      ...
      throw new Error(`Invalid JSON returned by HF: ${resultText}`);
    }
...
// -----------------------------
app.get("/", (req, res) => {
  res.send("✅ WaterMeter Backend Running Successfully on Render");
});
